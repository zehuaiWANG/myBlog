...
但是它的getReplicaSetPodInfo只通过label selector，应该是有bug的，我提了一个issue： [The Pods status in ReplicaSet is not correct](The Pods status in ReplicaSet is not correct)
